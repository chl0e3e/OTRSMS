...
@__DSOCacheEntry_name.3 = internal constant [13 x i8] c"libgcrypt.so\00", align 1
@__DSOCacheEntry_name.4 = internal constant [16 x i8] c"libmonodroid.so\00", align 1
@__DSOCacheEntry_name.5 = internal constant [10 x i8] c"libotr.so\00", align 1
@__DSOCacheEntry_name.6 = internal constant [22 x i8] c"libxa-internal-api.so\00", align 1
@__DSOCacheEntry_name.7 = internal constant [16 x i8] c"libgpg-error.so\00", align 1
...
@dso_cache = local_unnamed_addr global [40 x %struct.DSOCacheEntry] [
	...
	; 2
	%struct.DSOCacheEntry {
		i64 159274493, ; hash 0x97e55fd, from name: gcrypt
		i8 0, ; ignore
	...
	; 4
	%struct.DSOCacheEntry {
		i64 276066358, ; hash 0x10747036, from name: otr.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 5
	%struct.DSOCacheEntry {
	...
	; 6
	%struct.DSOCacheEntry {
		i64 637418919, ; hash 0x25fe3da7, from name: libgpg-error.so
		i8 0, ; ignore
	...
	; 7
	%struct.DSOCacheEntry {
		i64 677832961, ; hash 0x2866e901, from name: libotr
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 13
	%struct.DSOCacheEntry {
		i64 1378941146, ; hash 0x5230f8da, from name: gpg-error
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 16
	%struct.DSOCacheEntry {
		i64 1811213423, ; hash 0x6bf4ec6f, from name: libotr.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 17
	%struct.DSOCacheEntry {
		i64 1812386135, ; hash 0x6c06d157, from name: otr
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 18
	%struct.DSOCacheEntry {
		i64 1956501339, ; hash 0x749dd75b, from name: libgcrypt.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 23
	%struct.DSOCacheEntry {
		i64 2542549075, ; hash 0x978c3853, from name: libgcrypt
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 33
	%struct.DSOCacheEntry {
		i64 3692985788, ; hash 0xdc1e7dbc, from name: gpg-error.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 38
	%struct.DSOCacheEntry {
		i64 3970335422, ; hash 0xeca682be, from name: libgpg-error
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 39
	%struct.DSOCacheEntry {
		i64 4121626575, ; hash 0xf5ab07cf, from name: gcrypt.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}
