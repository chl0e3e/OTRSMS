...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"65c66a02-fd4f-48d2-80d4-43338106c397\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [23 x i8] c"com.companyname.otrsms\00", align 16
...
@__DSOCacheEntry_name.1 = internal constant [16 x i8] c"libgpg-error.so\00", align 16
...
@__DSOCacheEntry_name.6 = internal constant [10 x i8] c"libotr.so\00", align 1
...
@__DSOCacheEntry_name.10 = internal constant [13 x i8] c"libgcrypt.so\00", align 1

; dso_cache
@dso_cache = local_unnamed_addr global [40 x %struct.DSOCacheEntry] [
	; 0
	%struct.DSOCacheEntry {
		i64 1325865922991078738, ; hash 0x12666c083fadbd52, from name: libgpg-error.so
		i8 0, ; ignore
	...
	; 3
	%struct.DSOCacheEntry {
		i64 2213916421870085251, ; hash 0x1eb969417ff86483, from name: gpg-error
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 6
	%struct.DSOCacheEntry {
		i64 3619661283025780680, ; hash 0x323b9ec255fc7fc8, from name: libgpg-error
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 9
	%struct.DSOCacheEntry {
		i64 3886646484026462722, ; hash 0x35f0246287eb1202, from name: gpg-error.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 10
	%struct.DSOCacheEntry {
		i64 4706515335119989676, ; hash 0x4150e6c2d7c16bac, from name: otr.so
		i8 0, ; ignore
	...
	; 17
	%struct.DSOCacheEntry {
		i64 8034976340495053836, ; hash 0x6f81f86919e0340c, from name: otr
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 23
	%struct.DSOCacheEntry {
		i64 10277616351688421481, ; hash 0x8ea16d9e64227069, from name: libotr.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 26
	%struct.DSOCacheEntry {
		i64 12753919075098861920, ; hash 0xb0ff05d35d58a160, from name: gcrypt
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 27
	%struct.DSOCacheEntry {
	...
	; 28
	%struct.DSOCacheEntry {
		i64 13134933445759988953, ; hash 0xb648a86086ebf4d9, from name: gcrypt.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 30
	%struct.DSOCacheEntry {
		i64 14410028214680827256, ; hash 0xc7fab4504b683578, from name: libgcrypt
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 33
	%struct.DSOCacheEntry {
		i64 14859901185583193744, ; hash 0xce38f965ac179e90, from name: libgcrypt.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__DSOCacheEntry_name.10, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 34
	%struct.DSOCacheEntry {
		i64 15273640176380182093, ; hash 0xd3f6ded134467e4d, from name: libotr
		i8 0, ; ignore
		i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
