...
{
    public struct GPGError
    {
        public static ushort GPG_ERR_CODE_MASK = 65536 - 1;
        public static ushort GPG_ERR_CODE_SHIFT = 16;

        public static ushort GPG_ERR_SOURCE_MASK = 128 - 1;
        public static ushort GPG_ERR_SOURCE_SHIFT = 24;

        public static GPGError Marshal(uint error)
        {
            return new GPGError(error);
        }
        ...
        /// </summary>
        /// <param name="error">Error value to decode</param>
        public GPGError(uint error)
        {
            Code = (Code) ((ushort) error);
            Source = (Source) ((error & GPG_ERR_SOURCE_MASK) >> GPG_ERR_SOURCE_SHIFT);
        }
    }
